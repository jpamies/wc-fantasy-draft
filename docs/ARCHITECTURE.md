...
> Estado: documento arquitectónico general. Algunos ejemplos funcionales pueden no reflejar las últimas reglas de juego.
> Para reglas vigentes, consultar `docs/RULES.md`, `docs/SCORING.md` y `README.md`.
